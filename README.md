...
| withHeader           | if set `true`, the first row will be in a thead and will contain th cells                                                                                                                                                                 | `boolean`                                                                       | `false`                                    |
| withHeaderSwitch     | enable to choose insert a header                                                                                                                                                                                                          | `boolean`                                                                       | `false`                                    |
